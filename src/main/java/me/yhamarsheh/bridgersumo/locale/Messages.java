...
public enum Messages {
    ...
    JOINED_GAME("joined_game", "&e%luckperms_prefix% %player_name% has joined. &7(%players%/%maxplayers%)"),
    LEFT_GAME("left_game", "&e%luckperms_prefix% %player_name% has left. &7(%players%/%maxplayers%)"),
    FELL_INTO_THE_VOID("fell_into_the_void", "&b%player_name% &7fell into the void"),
    PUSHED_INTO_THE_VOID("pushed_into_the_void", "&b%player_name% &7was pushed into the void by &b%pusher_name%"),
    ...
    GOLD_BLOCK_WIN_TIMER("gold_block_win_timer", "&e%player_name% has been on the &6centre block &efor &a%seconds% seconds&e!"),
    CLINCHED_THE_WIN("clinched_the_win", "&7\n&7\n&e%player_name% has clinched the win by holding the gold block for &a20 seconds&e!\n&7\n&7"),
